...
-132z"/>
        ...
        <ul class="sidebar-list">
            @if(\App\Models\Settings::find(1)->Home === 'yes')
            ...
            @endif
                @if(\App\Models\Settings::find(1)->Scoreboard === 'yes')
                ...
                @endif
                @if(\App\Models\Settings::find(1)->Statistics === 'yes')
                ...
                @endif
                @if(\App\Models\Settings::find(1)->Logout === 'yes')
