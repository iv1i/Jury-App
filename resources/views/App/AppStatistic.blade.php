...
@section('title', 'AltayCTF-Sch-Statistic')

@section('appcontent')
    <div class="app-content">
        <div id="FormSwitchTheme" class="app-content-header">
            <h1 class="app-content-headerText">{{ __('Statistics') }}</h1>
...
@section('scripts')
    <script type="text/javascript">
        ...
        Echo.private(`channel-app-statistic`).listen('AppStatisticEvent', (e) => {
            ...
            for (let i = 0; i < valueToDisplay.length; i++){
                ...
                if (valueToDisplay[i].id == authuserid){
                    ...
                    valueToDisplay[i].BorderStyle = '';
                }
            }
            //const sortedData = valueToDisplay.sort((a, b) => b.scores - a.scores);
            //console.log(sortedData);
            const sortedData = valueToDisplay.sort((a, b) => b.scores - a.scores);
            MakeHTML(sortedData, divElement);
            //console.log(e.test);
        ...
        var sortButton2 = document.querySelector('.sort-button-id');
        var sortButton3 = document.querySelector('.sort-button-scores');
        ...
        sortButton1.addEventListener('click', function () {
            ...
            isSorted3 = 0;
            isSorted4 = 0;
            Sorting(Teams, originalTeams, divElementSort, isSorted1, 'wherefrom')
            if (isSorted1 >= 2){
                isSorted1 = 0;
            }
        });
        sortButton2.addEventListener('click', function () {
            ...
            isSorted3 = 0;
            isSorted4 = 0;
            Sorting(Teams, originalTeams, divElementSort, isSorted2, 'id')
            if (isSorted2 >= 2){
                isSorted2 = 0;
            }
        });
        sortButton3.addEventListener('click', function () {
            ...
            isSorted3 = 0;
            isSorted4 = 0;
            Sorting(Teams, originalTeams, divElementSort, isSorted3, 'scores')
            if (isSorted3 >= 2){
                isSorted3 = 0;
            }
        });
        ...
        function SortDirect(M, column){
            ...
            if (column === "wherefrom"){
                M.sort(function (a, b) {
                    ...
                    // Если оба имеют или не имеют значение в decide, сортируем по category
                    var nameA = a.wherefrom.toLowerCase();
                    var nameB = b.wherefrom.toLowerCase();
