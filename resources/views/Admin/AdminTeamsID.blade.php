...
@section('appcontent')
    <div class="app-content">
        <div id="FormSwitchTheme" class="app-content-header">
            <h1 class="app-content-headerText">{{ \App\Models\Teams::find($data['id'])->name }} #{{ $data['id'] }}</h1>
        ...
        <div class="topmost-div">
            <div style="text-align: center; color: white; height: 3vw;">
                ...
                <a href="/Admin/Teams/" id="CloseBtn" class="btnclose"><img class="closeicontask"
                                                                            src="{{ asset('media/icon/close.png') }}"></a>
            </div>
            <form action="/Admin/Teams/Change" method="POST" id="MyFormPlus" class="form" enctype="multipart/form-data">
                ...
                <div class="form_item">
                    <div>Лого</div>
                    <div><img id="teamlogoimg" style="height: 7vw;"
                              src="{{ asset('storage/teamlogo/' . $data['team']->teamlogo) }}"></div>
        ...
        <a href="{{ route('AdminTeams') }}"
           style="width: 100%; height: 100%; background-color: white; position:absolute; opacity: .0"></a>
    </div>
    @if ($errors->any())
                ...
                <i class="fa-solid fa-xmark close">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g id="Menu / Close_SM">
                                <path id="Vector" d="M16 16L12 12M12 12L8 8M12 12L16 8M12 12L8 16" stroke="#77767b"
...
@section('scripts')
    ...
    <script type="text/javascript">
        const data = {!! json_encode(\App\Models\Teams::all()) !!};
